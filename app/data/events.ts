...
export const COLLECTIONS: CollectionItem[] = [
  {
    ...
    description: "A ninety-minute weave of percussive traditions from across the world, performed in a forty-seat listening room.",
    time: "Jan 2026",
    active: true,
    details: {
  ...
  },
  {
    ...
    location: "TBD",
    image: null,
    description: "Environmental soundscapes captured across the Marina coastline.",
    time: "July-Aug 2026",
    active: false,
  },
];
